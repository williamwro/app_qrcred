...
package br.com.qrcred.libupdate;
...
import static br.com.qrcred.libupdate.Constants.UpdateMode;
 ...
 * </div>
 */
public class InAppUpdateManager implements DefaultLifecycleObserver {
    ...
    private void startAppUpdateImmediate(AppUpdateInfo appUpdateInfo) {
        try {
            // Criação de AppUpdateOptions para o tipo de atualização imediata.
            AppUpdateOptions appUpdateOptions = AppUpdateOptions.newBuilder(AppUpdateType.IMMEDIATE)
                    .build();

            appUpdateManager.startUpdateFlowForResult(
                    appUpdateInfo, // Informações sobre a atualização.
                    activity, // A atividade atual que faz a solicitação de atualização.
                    appUpdateOptions, // Opções de atualização configuradas acima.
                    requestCode); // Código de solicitação para monitorar essa solicitação de atualização.
    ...
    private void startAppUpdateFlexible(AppUpdateInfo appUpdateInfo) {
        try {
            // Criação de AppUpdateOptions para o tipo de atualização flexível.
            AppUpdateOptions appUpdateOptions = AppUpdateOptions.newBuilder(AppUpdateType.FLEXIBLE)
                    .build();
