...
public class GeraCpfCnpj {
    ...
    public String cpf(boolean comPontos) {
        ...
        if (comPontos)
            retorno = String.valueOf(n1) + n2 + n3 + '.' + n4 + n5 + n6 + '.' + n7 + n8 + n9 + '-' + d1 + d2;
        else
            retorno = String.valueOf(n1) + n2 + n3 + n4 + n5 + n6 + n7 + n8 + n9 + d1 + d2;
    ...
    public String cnpj(boolean comPontos) {
        ...
        if (comPontos)
            retorno = String.valueOf(n1) + n2 + "." + n3 + n4 + n5 + "." + n6 + n7 + n8 + "/" + n9 + n10 + n11 + n12 + "-" + d1 + d2;
        else
            retorno = String.valueOf(n1) + n2 + n3 + n4 + n5 + n6 + n7 + n8 + n9 + n10 + n11 + n12 + d1 + d2;
    ...
    public String rg(boolean comPontos) {
        ...
        if (comPontos)
            numeroGerado = String.valueOf(n1) + n2 + "." + n3 + n4 + n5 + "." + n6 + n7 + n8 + "-" + n9;
        else
            numeroGerado = String.valueOf(n1) + n2 + n3 + n4 + n5 + n6 + n7 + n8 + n9;
