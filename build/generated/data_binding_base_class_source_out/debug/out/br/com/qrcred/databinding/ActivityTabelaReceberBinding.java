...
public final class ActivityTabelaReceberBinding implements ViewBinding {
  @NonNull
  ...
  private ActivityTabelaReceberBinding(@NonNull ScrollView rootView, @NonNull TextView textView,
  ...
  @NonNull
  public static ActivityTabelaReceberBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityTabelaReceberBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_tabela_receber, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityTabelaReceberBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityTabelaReceberBinding((ScrollView) rootView, textView, textView10,
          textView12, textView14, textView15, textView16, textView17, textView18, textView19,
          textView2, textView20, textView21, textView22, textView23, textView24, textView25,
          textView26, textView27, textView28, textView29, textView3, textView30, textView4,
